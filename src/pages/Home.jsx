...
const decisions = [
  ...
  "Maria Island skipped for this trip",
];
      ...
      <Layout title="Expedition HQ">
        ...
        <div className="grid" style={{ marginTop: 24 }}>
          <div className="card">
            ...
            <h2>Book Spirit of Tasmania</h2>
            <p>Scott and Jane need the ferry booked for the start of the expedition.</p>
          </div>

          <div className="card">
            <h3>✈️ Airport Pickup</h3>
